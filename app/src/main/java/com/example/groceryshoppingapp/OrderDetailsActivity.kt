...
//            order.invoiceUrl?.let {
//                val intent = Intent(Intent.ACTION_VIEW, Uri.parse(it))
//                startActivity(intent)
//            } ?: run {
//                Toast.makeText(this, "Invoice not available yet", Toast.LENGTH_SHORT).show()
//            }
//        }
//        btnViewInvoice.setOnClickListener {
//            val invoiceUrl = order.invoiceUrl?.trim()
//            if (!invoiceUrl.isNullOrEmpty() && invoiceUrl.startsWith("http", ignoreCase = true)) {
//                try {
//                    val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse(invoiceUrl))
//                    browserIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
//                    startActivity(browserIntent)
//                } catch (e: Exception) {
//                    Toast.makeText(this, "No app available to open invoice", Toast.LENGTH_SHORT).show()
//                }
//            } else {
//                Toast.makeText(this, "Invoice not available yet", Toast.LENGTH_SHORT).show()
//            }
